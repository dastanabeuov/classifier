...
ActiveRecord::Schema.define(version: 20_210_422_040_501) do
  ...
  create_table 'properties', id: :serial, force: :cascade do |t|
    ...
    t.index %w[propertyable_type propertyable_id], name: 'index_properties_on_propertyable_type_and_propertyable_id'
  end
